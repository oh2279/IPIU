...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=10, zero_init_residual=False,
        ...
        self.transform = transform(512 * block.expansion)
    ...
    def forward(self, x):
        ...
        #if self.training :
        #print(x.shape)
        #feature.append(self.transform1(x.mean(dim=0)))
        #feature.append(x.mean(dim=0))
       ...
       #if self.training :
        #print(x.shape)
        #feature.append(self.transform2(x.mean(dim=0)))
        #feature.append(x.mean(dim=0))
       ...
       #if self.training :
        #print(x.shape)
        #feature.append(self.transform3(x.mean(dim=0)))
        #feature.append(x.mean(dim=0))
        ...
        for blk in self.layer4:
            ...
            h += 1
        #if self.training :
        #feature.append(self.transform(x.mean(dim=0)))
        #feature.append(x.mean(dim=0))
        x = self.avgpool(x)
