...
def fetch_dataloader(params,world_size,rank):
    ...
    mean = {
        ...
        'V2_sar' : 0.5200,
        'MSTAR_10' : 0.1449,
        'WHU_OPT_SAR_opt' : (0.4105, 0.3793, 0.3102),
        'WHU_OPT_SAR_sar' : 0.2117,
        }
    ...
    std = {
        ...
        'V2_sar' : 0.1776,
        'MSTAR_10' : 0.1204,
        'WHU_OPT_SAR_opt' : (0.0471, 0.0538, 0.0635),
        'WHU_OPT_SAR_sar' : 0.1783,
        }
    
 
    mean_opt = mean[params.dataset + '_opt']
    std_opt = std[params.dataset + '_opt']
    mean_sar = mean[params.dataset + '_sar']
    std_sar = std[params.dataset + '_sar']
    ...
    trainset = datasets.V2Dataset(root_dir='/home/gpuadmin/data/v2', train=True, optical_transform=train_optical_transform, sar_transform=train_sar_transform)
    devset = datasets.V2Dataset(root_dir='/home/gpuadmin/data/v2', train=False, optical_transform=test_optical_transformer, sar_transform=test_sar_transformer)
